...
namespace Nevma.Files.Api.Infrastructure.Authentication;

public static class AuthenticationConfiguration
{
    public static IServiceCollection AddFilesAuthentication(this IServiceCollection services, IConfiguration configuration)
    {
